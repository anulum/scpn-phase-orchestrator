...
// scpn-phase-orchestrator — federation contract regression guards
...
describe("module federation contract", () => {
  it("keeps the locked federation name and expose key", () => {
    expect(FEDERATION_NAME).toBe("scpn_phase_orchestrator");
    ...
    expect(PANEL_EXPOSE_KEY).toBe("./SpoStudioPanel");
  });
