...
simplicial_run_mojo = _simplicial_mojo.simplicial_run_mojo
...
BACKEND_MODULES = (
    ...
    "scpn_phase_orchestrator.monitor._opt_entropy_go",
    "scpn_phase_orchestrator.monitor._opt_entropy_julia",
    "scpn_phase_orchestrator.monitor._opt_entropy_mojo",
    ...
    "scpn_phase_orchestrator.monitor._twin_confidence_go",
    "scpn_phase_orchestrator.monitor._twin_confidence_julia",
    "scpn_phase_orchestrator.monitor._twin_confidence_mojo",
    ...
    "scpn_phase_orchestrator.experimental.accelerators.monitor._twin_confidence_validation",
    ...
    "scpn_phase_orchestrator.experimental.accelerators.monitor._opt_entropy_validation",
