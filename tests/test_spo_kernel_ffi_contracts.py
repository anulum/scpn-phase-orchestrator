...
# SCPN Phase Orchestrator — spo-kernel FFI public contracts

"""
Public PyO3/FFI contracts for spo_kernel.  These tests are skipped when the optional
Rust extension is unavailable and verify the exported Rust-backed Python API mirrors
required numerical, boundary, and supervisor behaviours.
"""
...
# Pipeline wiring is proven by the FFI integration tests above:
# they verify every Rust module mirrors the Python implementation.
