...
# SCPN Phase Orchestrator — Domainpack binding workflow contracts

"""
Workflow contracts for loading domainpack binding specs into executable dynamics.
Each scenario crosses modules because the production contract is domainpack YAML ->
BindingSpec -> coupling construction -> UPDE dynamics -> monitor/regime evaluation.
"""
