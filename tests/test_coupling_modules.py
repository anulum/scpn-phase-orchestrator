...
class TestPipelineWiring:
    ...
    def test_lag_alpha_with_template_drives_engine(self):
        """LagModel → alpha + KnmTemplate → engine → R∈[0,1].
        Proves all coupling modules compose into the engine."""
        import numpy as np
