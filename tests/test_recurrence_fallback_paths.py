...
# SCPN Phase Orchestrator — Recurrence fallback path contracts

"""
Fallback and numerical edge contracts for recurrence monitors.  These tests verify
backend-dispatch failure behaviour, missing-kernel fallback, constant-trajectory RQA
invariants, and invalid epsilon rejection.
"""
