...
def test_reactor_semantics_reference_preserves_u0_boundaries() -> None:
    ...
    required = (
        ...
        "tokamak, dense- plasma-focus, and MagLIF device plans",
        ...
        "Passing either design review does not add source evidence",
...
def test_reactor_configuration_coverage_is_exhaustive_and_fail_closed() -> None:
    ...
    required = (
        ...
        "dense- plasma-focus, and MagLIF producer fixtures",
        "both still have no configuration-specific source evidence",
        "MagLIF does not inherit the verified `frc_compression_mif` adapter",
