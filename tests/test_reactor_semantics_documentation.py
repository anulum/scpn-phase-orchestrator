...
def test_reactor_semantics_reference_preserves_u0_boundaries() -> None:
    ...
    required = (
        ...
        "direct-drive evidence or authority is never inherited",
...
def test_device_physical_evidence_request_is_exact_and_fail_closed() -> None:
    ...
    required = (
        ...
        "fifth materialised request selects only `laser_icf_fast_or_shock_ignition`",
        "inherits no direct-drive physical sample",
