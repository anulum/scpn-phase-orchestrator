...
def test_reactor_semantics_reference_preserves_u0_boundaries() -> None:
    ...
    required = (
        ...
        "tokamak, dense- plasma-focus, MagLIF, and mechanical-or-liquid-liner "
        "MIF device plans",
        ...
        "Both liner-MIF reviews keep compression-trajectory",
        "without equating their device identities or timescales",
        "all three device-plan-only semantic-ingress profiles remain `not_declared`",
...
def test_reactor_configuration_coverage_is_exhaustive_and_fail_closed() -> None:
    ...
    required = (
        ...
        "dense- plasma-focus, MagLIF, and mechanical-or-liquid-liner MIF "
        "producer fixtures",
        "the latter three fixtures do not change their matrix rows",
        "Neither MagLIF nor mechanical-or-liquid- liner MIF inherits the "
        "verified `frc_compression_mif` adapter",
        "the two liner design reviews also do not provide evidence for each other",
