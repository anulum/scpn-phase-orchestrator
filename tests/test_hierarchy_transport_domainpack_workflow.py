...
# SCPN Phase Orchestrator — Hierarchy transport domainpack workflow contracts

"""
Workflow contracts for hierarchy transport replay demos.  The tests cross domainpack
modules because the production contract is demo payload generation -> transport
boundary records -> deterministic JSON artifact handoff.
"""
