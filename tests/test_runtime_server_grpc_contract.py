...
# SCPN Phase Orchestrator — Runtime server gRPC contract tests

"""
Public gRPC contract for PhaseStreamServicer over SimulationState.  The tests use an
in-process servicer and mocked context to verify GetState, Step, Reset, and
GetConfig without opening sockets or depending on grpcio availability.
"""
...
# Pipeline wiring: TestGRPCIntegration exercises Step/Reset/GetConfig/GetState
# through the gRPC servicer which wraps SimulationState + UPDEEngine.
