...
class TestGaianMesh:
    ...
    def test_two_node_communication(self):
        node1 = GaianMeshNode("node1", port=12002, peer_addresses=[("127.0.0.1", 12003)], heartbeat_interval_s=0.01)
        node2 = GaianMeshNode("node2", port=12003, peer_addresses=[("127.0.0.1", 12002)], heartbeat_interval_s=0.01)
    ...
    def test_three_node_consensus(self):
        node1 = GaianMeshNode("node1", port=12004, peer_addresses=[("127.0.0.1", 12005), ("127.0.0.1", 12006)], heartbeat_interval_s=0.01)
        node2 = GaianMeshNode("node2", port=12005, peer_addresses=[("127.0.0.1", 12004), ("127.0.0.1", 12006)], heartbeat_interval_s=0.01)
        node3 = GaianMeshNode("node3", port=12006, peer_addresses=[("127.0.0.1", 12004), ("127.0.0.1", 12005)], heartbeat_interval_s=0.01)
