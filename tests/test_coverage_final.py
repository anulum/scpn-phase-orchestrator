...
# Pipeline wiring: coverage tests exercise PIDController, EnvelopeViolationScorer,
# PredictiveRegime, CouplingEstimator, QueueWaves, and server endpoints. Each uses
# engine or UPDEState directly.
