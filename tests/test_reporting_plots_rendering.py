...
# SCPN Phase Orchestrator — Reporting plot rendering contracts

"""
Rendering contracts for reporting.plots.CoherencePlot.  These tests assert real plot
artefacts are created for timelines, action audits, amplitude traces, and PAC
heatmaps rather than touching plotting lines for coverage.
"""
