...
# SCPN Phase Orchestrator — Imprint and audit replay workflow contracts

"""
Workflow contracts for imprint-driven coupling and audit replay.  These tests cross
module boundaries only where the production workflow requires it: ImprintModel ->
coupling/UPDE dynamics, and AuditLogger -> ReplayEngine hash-chain/determinism
replay.
"""
