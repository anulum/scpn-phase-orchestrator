...
export class WasmEngine {
     ...
     */
    get_phases() {
        const ret = wasm.wasmengine_get_phases(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} n
     */
    constructor(n) {
        const ret = wasm.wasmengine_new(n);
     ...
     * @returns {number}
     */
    run(omegas, coupling, dt, n_steps) {
        const ret = wasm.wasmengine_run(this.__wbg_ptr, omegas, coupling, dt, n_steps);
        return ret;
    }
    /**
     * @param {Float64Array} new_phases
     */
    set_phases(new_phases) {
        wasm.wasmengine_set_phases(this.__wbg_ptr, new_phases);
    }
    /**
     * @param {Float64Array} omegas
     * @param {number} coupling
     ...
     * @returns {number}
     */
    step(omegas, coupling, dt) {
        const ret = wasm.wasmengine_step(this.__wbg_ptr, omegas, coupling, dt);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('spo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
