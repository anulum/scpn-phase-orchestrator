...
# SCPN Phase Orchestrator — Strang splitting multi-backend benchmark

"""Per-backend wall-clock benchmark for
``upde.splitting.SplittingEngine.run`` (Strang second-order
operator splitting, A(dt/2) → B(dt) → A(dt/2))."""
...
from scpn_phase_orchestrator.upde.splitting import (
    ACTIVE_BACKEND,
    AVAILABLE_BACKENDS,
    SplittingEngine,
)
