...
# SCPN Phase Orchestrator — PHA-C handoff julia contract

"""PHA-C handoff julia adapter contract."""
...
def build_pha_c_handoff_record_julia(
    *args: object,
    **kwargs: object,
) -> PHACHandoffRecord:
    """Evaluate the julia handoff contract against the reference."""
