...
# SCPN Phase Orchestrator — PHA-C acceptance go contract

"""PHA-C acceptance go adapter contract."""
...
def build_pha_c_acceptance_record_go(
    *args: object,
    **kwargs: object,
) -> PHACAcceptanceRecord:
    """Evaluate the go acceptance contract against the reference."""
