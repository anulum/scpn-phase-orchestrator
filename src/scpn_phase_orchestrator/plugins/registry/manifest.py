...
# SCPN Phase Orchestrator — Plugin manifest validation and discovery

"""Manifest validation, compatibility reporting, discovery, and catalogue assembly."""
...
from ._shared import _VALID_KINDS, _require_identifier, _require_non_empty
