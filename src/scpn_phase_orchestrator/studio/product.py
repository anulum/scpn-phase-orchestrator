...
STUDIO_REVIEW_PANEL_REGISTRY: tuple[PanelRecord, ...] = (
    ...
    {
        "panel_id": "autopoietic_lineage_sandbox",
        "title": "Autopoietic lineage sandbox",
        "builder": "build_autopoietic_lineage_studio_panel",
        "claim_boundary": "autopoietic_lineage_sandbox_review_not_live_merge",
        "source_rows": ("Autopoietic lineage sandbox",),
        "required_evidence": (
    ...
    {
        "panel_id": "intergenerational_policy_inheritance",
        "title": "Intergenerational policy inheritance",
        "builder": "build_intergenerational_inheritance_studio_panel",
        "claim_boundary": "intergenerational_inheritance_review_not_direct_hot_patch",
        "source_rows": ("Intergenerational policy inheritance",),
        "required_evidence": (
