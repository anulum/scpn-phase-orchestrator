...
try:
    ...
    from scpn_phase_orchestrator.runtime.grpc_gen.spo_pb2 import (  # type: ignore[attr-defined]
        ConfigRequest,
        ConfigResponse,
        LayerState,
        ResetRequest,
...
try:
    from scpn_phase_orchestrator.runtime.grpc_gen.spo_pb2_grpc import (
    ...
    from scpn_phase_orchestrator.runtime.grpc_gen._spo_pb2_grpc_fallback import (  # type: ignore[assignment]
        PhaseOrchestratorServicer,
        add_PhaseOrchestratorServicer_to_server,
    )
