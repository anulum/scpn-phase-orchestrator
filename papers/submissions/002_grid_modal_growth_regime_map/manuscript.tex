...
AI-assisted technologies (Anthropic Claude large-language-model
tooling) were used to assist with software development, analysis
tooling and manuscript drafting. The author specified, verified and
approved all methods, analyses and claims, and takes full
responsibility for the content of this work.

\section*{Competing interests}

The author develops the open-source SCPN Phase Orchestrator software
used in this study, which is also offered under a commercial licence.
