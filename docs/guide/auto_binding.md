...
correlation graph, connected-component clusters, and the sampling-rate
inference path. Non-phase tables carry an explicit phase-SINDy skipped status
instead of a fitted phase model. These records are audit evidence for operator
review; they do not enable automatic actuation.
