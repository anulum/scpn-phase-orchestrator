...
| Coverage debt closure | historical fixes added behaviour coverage for five modules and local coverage guard passes | reduce residual source coverage debt versus the historical CI baseline, then refresh the internal coverage inventory from current CI artefacts |
