...
| Hierarchical orchestration | reduced-summary parent orchestration, bounded escalation audit records, deterministic edge/cloud sync envelopes, and power-grid/cardiac replay demos are implemented; live transport and broader multi-domain demos remain open |
