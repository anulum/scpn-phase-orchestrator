...
| Digital-twin binding standard | deterministic binding contract export is implemented for timing, layers, actuators, N-channel algebra, sync capabilities, and contract hashes; live transport adapters remain open |
