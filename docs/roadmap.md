...
| Value-alignment supervisor guard | guard foundation, binding-spec templates, and counterfactual violation/score reporting are implemented; domainpack-specific ethical prior templates remain open |
