...
| Morphogenetic field topology | field foundation and dependency-free snapshot visualisation are implemented; domainpack demos and richer UI rendering remain open |
