...
| Morphogenetic field topology | field foundation, dependency-free snapshot visualisation, plus swarm-robotics split-flock and power-grid stressed-replay demos are implemented; additional domainpack demos and richer UI rendering remain open |
