...
| Plugin ecosystem | manifest registry, entry-point discovery, capabilities, compatibility checks, audit records, marketplace catalogue, runnable example, CLI export, Rust-facing registry export, guarded metadata-only Rust handoff manifests, grouped dispatch records, and loading-disabled gates are implemented | build deeper owned runtime loading |
