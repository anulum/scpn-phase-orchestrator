...
| STL runtime verification | robustness monitor foundation, policy YAML `stl_monitors` integration, PRISM export linkage, builtin monitoring automata synthesis, and non-actuating controller-candidate synthesis are implemented; closed-loop controller synthesis remains open |
