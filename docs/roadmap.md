...
| Guided deployment path | deployment readiness and package manifests now carry target status, required artefacts, export hashes, commands, blocked reasons, and safety gates for Docker/WASM/hardware review; package materialisation commands remain open |
