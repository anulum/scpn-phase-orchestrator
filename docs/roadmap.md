...
| Hierarchical orchestration | reduced-summary parent orchestration, bounded escalation audit records, and deterministic edge/cloud sync envelopes are implemented; live transport and domainpack demos remain open |
