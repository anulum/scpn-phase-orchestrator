...
| Coverage debt closure | historical fixes added behaviour coverage for five modules, local coverage guard passes, focused Studio/CLI/supervisor behaviour tests cover residual service-manifest, auto-coupling CLI, formal-readiness, policy-branching, and hierarchy-ingestion paths, focused quantum/causal/meta/autotune/reporting/QPU tests cover residual adapter validation, deterministic manifests, malformed-input rejection, and artefact parsing paths, focused QueueWaves/binding/monitor tests cover residual runtime, config, digital-twin, semantic, recurrence, and ITPC fallback paths, focused coupling/UPDE/supervisor/plugin tests cover residual spectral, Hodge, attention-residual, market, bifurcation, plugin, sheaf, alignment, predictive, Byzantine, and topology edge paths, and focused visualisation/reporting/SSGF/imprint/adapter tests cover residual rendering, summary, streamer, free-energy, carrier, PGBO, imprint, Redis-schema, Modbus, QPU artefact, and hybrid co-compiler boundaries | reduce residual source coverage debt versus the historical CI baseline, then refresh the internal coverage inventory from current CI artefacts |
