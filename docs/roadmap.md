...
| Morphogenetic field topology | field foundation, dependency-free snapshot visualisation, and a swarm-robotics split-flock demo are implemented; additional domainpack demos and richer UI rendering remain open |
