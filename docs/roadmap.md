...
| RL/autotune layer on JAX `nn` backend | reward evaluation and replay candidate ranking are implemented; next step is offline policy-search generation before PPO/SAC or live actuation |
