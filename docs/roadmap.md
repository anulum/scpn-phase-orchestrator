...
| Sheaf-cohomology control | supervisor foundation, edge-consensus, power-grid, and network-security heterogeneous-domain demos, obstruction-summary triage, deterministic top-residual evidence, and reference-suite gates are implemented; additional heterogeneous-domain demos remain open |
