...
- Observer snapshots from PGBO and topological-integration (diagnostic only).
...
and the topological-integration observable (a persistent-homology topological-integration observer, `ripser`/PLV)
produce diagnostics; the integration gate feeds the coupling plasticity update.
...
**not** invoked in the default simulation; integration is user-driven. The topological-integration observable
...
objective. PGBO / topological-integration are observation-only — they do not fail a step or block
actuation.
