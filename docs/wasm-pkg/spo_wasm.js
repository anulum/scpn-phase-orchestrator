 ...
 * @param {string} omega_json
 * @param {number} coupling
 * @param {number} dt
 * @returns {number}
 */
export function step(omega_json, coupling, dt) {
    const ptr0 = passStringToWasm0(omega_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.step(ptr0, len0, coupling, dt);
    return ret;
}
