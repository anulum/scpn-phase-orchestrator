...
| --- | --- | ---: | ---: |
| `auto_binding` | `auto_binding_synthetic_quality` | `n/a` | `42.8699` |
| `autopoietic_lineage` | `autopoietic_lineage_sandbox_gate` | `1` | `12456.9` |
| `bayesian_backends` | `bayesian_backend_fail_closed` | `1` | `2173.76` |
| `bayesian_posterior` | `bayesian_posterior_fit_quality` | `1` | `4450.5` |
| `domain_formal_export` | `domain_formal_safety_exports` | `1` | `21211.1` |
| `evolutionary_mutation_grammars` | `evolutionary_mutation_grammar_gate` | `1` | `588.735` |
| `evolutionary_supervisor_search` | `evolutionary_supervisor_search` | `1` | `3620.06` |
| `federated_deployment_preflight` | `federated_deployment_preflight_gate` | `1` | `1544.56` |
| `federated_meta_orchestrator` | `federated_meta_orchestrator` | `1` | `4057.32` |
| `federated_production_boundary` | `federated_production_boundary_gate` | `1` | `1888.56` |
| `formal_export` | `formal_export_artifact_quality` | `1` | `7932.44` |
| `hybrid_cocompiler` | `hybrid_cocompiler_review_gate` | `1` | `7766.87` |
| `hybrid_entanglement_order` | `hybrid_entanglement_order_parameter_gate` | `1` | `536.154` |
| `hybrid_operator_handoff` | `hybrid_operator_handoff_package_gate` | `1` | `13935.2` |
| `hybrid_target_readiness` | `hybrid_target_readiness_gate` | `1` | `16497.7` |
| `information_geometry_control` | `information_geometry_control_gate` | `1` | `0.815036` |
| `integrated_information_replay_corpus` | `integrated_information_replay_corpus_gate` | `1` | `200.079` |
| `intergenerational_inheritance` | `intergenerational_policy_inheritance_gate` | `1` | `6715.65` |
| `kuramoto` | `kuramoto_reference_strogatz_2000` | `n/a` | `7015.93` |
| `meta_transfer` | `meta_transfer_package_manifest_quality` | `1` | `4119.79` |
| `meta_transfer_corpus` | `meta_transfer_audit_corpus_quality` | `1` | `419.089` |
| `morphogenetic_domain_demos` | `morphogenetic_domain_demo_gate` | `1` | `50.2491` |
| `multiverse_counterfactual` | `multiverse_counterfactual_gate` | `1` | `818.94` |
| `neuromorphic_target_readiness` | `neuromorphic_target_readiness_gate` | `1` | `10315.8` |
| `petri_reachability` | `petri_net_reachability` | `n/a` | `171472` |
| `plugin_ecosystem` | `plugin_ecosystem_catalog_quality` | `1` | `4857.89` |
| `quantum_target_readiness` | `quantum_target_readiness_gate` | `1` | `14270` |
| `replay_policy` | `replay_policy_candidate_quality` | `1` | `463.217` |
| `self_model_digital_twin` | `self_model_digital_twin` | `1` | `804.115` |
| `semantic_retrieval` | `semantic_retrieval_ranking_quality` | `1` | `99.3901` |
| `sheaf_obstruction_domains` | `sheaf_obstruction_domain_gate` | `1` | `41.7051` |
| `stl_closed_loop` | `stl_closed_loop_plan_quality` | `1` | `5868.95` |
| `stuart_landau` | `stuart_landau_reference_pikovsky_2001` | `n/a` | `6717.36` |
| `temporal_causal_hypergraph` | `temporal_causal_hypergraph_experiment_gate` | `1` | `4671.11` |
| `topos_semantic_binding` | `topos_semantic_binding_gate` | `1` | `53.3079` |
| `value_alignment_replay_calibration` | `value_alignment_replay_calibration_gate` | `1` | `15898.8` |
...
```json
{
  ...
  "steps_per_second": 42.86985374008329,
  "suite": "auto_binding_synthetic_quality",
  "validation_error_count": 0,
  "wall_time_s": 0.09330566006246954
}
```
...
```json
{
  ...
  "steps_per_second": 12456.929139110878,
  "suite": "autopoietic_lineage_sandbox_gate",
  "wall_time_s": 0.0004013830330222845
}
```
...
```json
{
  ...
  "sample_count": 96,
  "steps_per_second": 4450.50394840325,
  "suite": "bayesian_posterior_fit_quality",
  "wall_time_s": 0.021570590906776488,
...
```json
{
  ...
  "failed_domain_count": 0,
  "steps_per_second": 21211.1116583808,
  "suite": "domain_formal_safety_exports",
  "wall_time_s": 0.00042430590838193893
}
```
...
```json
{
  ...
  "steps_per_second": 588.7353039043423,
  "suite": "evolutionary_mutation_grammar_gate",
  "wall_time_s": 0.03397112397942692
}
```
...
```json
{
  ...
  "steps_per_second": 3620.0592268595146,
  "stl_filter_rejected_count": 4,
  "suite": "evolutionary_supervisor_search",
  "wall_time_s": 0.005801010061986744
}
```
...
```json
{
  ...
  "steps_per_second": 4057.321841121813,
  "suite": "federated_meta_orchestrator",
  "total_sample_count": 300,
  "wall_time_s": 0.0007394040003418922
}
```
...
```json
{
  ...
  "steps_per_second": 7932.44148740967,
  "stl_prism_bytes": 808,
  "suite": "formal_export_artifact_quality",
  "wall_time_s": 0.0006303229602053761
}
```
...
```json
{
  ...
  "scenario_count": 8,
  "steps_per_second": 536.1543626378643,
  "suite": "hybrid_entanglement_order_parameter_gate",
  "wall_time_s": 0.014921076013706625
}
```
...
```json
{
  ...
  "steps_per_second": 13935.15252862487,
  "suite": "hybrid_operator_handoff_package_gate",
  "wall_time_s": 0.00014352193102240562
}
```
...
```json
{
  ...
  "record_count": 2,
  "steps_per_second": 16497.70555692664,
  "suite": "hybrid_target_readiness_gate",
  "wall_time_s": 0.00012122897896915674
}
```
...
```json
{
  ...
  "scenario_count": 4,
  "steps_per_second": 0.8150356082032517,
  "suite": "information_geometry_control_gate",
  "wall_time_s": 4.907761034904979
}
```
...
```json
{
  ...
  "steps_per_second": 200.07874774377856,
  "suite": "integrated_information_replay_corpus_gate",
  "wall_time_s": 0.05997638497501612
}
```
...
```json
{
  ...
  "steps_per_second": 6715.645064119653,
  "suite": "intergenerational_policy_inheritance_gate",
  "wall_time_s": 0.00029781204648315907
}
```
...
```json
{
  ...
  "n_oscillators": 64,
  "n_steps": 1000,
  "steps_per_second": 7015.931722647623,
  "suite": "kuramoto_reference_strogatz_2000",
  "wall_time_s": 0.14253274397924542
}
```
...
```json
{
  ...
  "package_sha256": "533acf3b37aa233b7a53da1903c99865a7e34055d3d5bcacef3501c3b9fd273f",
  "record_count": 4,
  "steps_per_second": 4119.787247578677,
  "suite": "meta_transfer_package_manifest_quality",
  "wall_time_s": 0.0009709239238873124
}
```
...
```json
{
  ...
  "record_count": 6,
  "steps_per_second": 419.08897277038517,
  ...
  "wall_time_s": 0.014316768967546523
}
```
...
```json
{
  ...
  "steps_per_second": 818.9401215310675,
  "suite": "multiverse_counterfactual_gate",
  "wall_time_s": 0.0048843619879335165
}
```
...
```json
{
  ...
  "steps_per_second": 171471.79800428462,
  "suite": "petri_net_reachability",
  "wall_time_s": 0.02915931399911642
}
```
...
```json
{
  ...
  "steps_per_second": 4857.890772595255,
  "suite": "plugin_ecosystem_catalog_quality",
  "wall_time_s": 0.0006175519665703177
}
```
...
```json
{
  ...
  "steps_per_second": 463.2166360928976,
  "suite": "replay_policy_candidate_quality",
  "unsafe_acceptance_count": 0,
  "wall_time_s": 0.01942935399711132
}
```
...
```json
{
  ...
  "steps_per_second": 804.1149837015698,
  "suite": "self_model_digital_twin",
  "wall_time_s": 0.004974412964656949
}
```
...
{
  "acceptance_passed": 1,
  "acceptance_thresholds_json": "{\"max_nominal_obstruction_score\": 0.35, \"min_critical_count\": 5, \"min_demo_count\": 6, \"min_obstruction_delta\": 0.1, \"min_summary_count\": 6, \"min_top_residual_edge_count\": 18, \"require_deterministic_hash\": true, \"require_non_actuating\": true}",
  "critical_count": 6,
  "deterministic_hash": 1,
  ...
  "sheaf_obstruction_sha256": "7899afc60a3b3bb7b9c99dc10ad86566605258626adf17caa7ee3b4018bcc40f",
  "steps_per_second": 41.705097316644235,
  "suite": "sheaf_obstruction_domain_gate",
  "summary_count": 6,
  "top_residual_edge_count": 18,
  "wall_time_s": 0.14386730606202036
}
```
...
```json
{
  ...
  "steps_per_second": 5868.946313649629,
  "suite": "stl_closed_loop_plan_quality",
  "wall_time_s": 0.0005111650098115206
}
```
...
```json
{
  ...
  "n_oscillators": 64,
  "n_steps": 1000,
  "steps_per_second": 6717.3601193686645,
  "suite": "stuart_landau_reference_pikovsky_2001",
  "wall_time_s": 0.14886800502426922
}
```
...
```json
{
  ...
  "research_only": 1,
  "steps_per_second": 4671.107021097087,
  "suite": "temporal_causal_hypergraph_experiment_gate",
  "wall_time_s": 0.0004281640285626054
}
```
...
```json
{
  ...
  "steps_per_second": 53.30789669373902,
  ...
  "wall_time_s": 0.11255368101410568
}
```
