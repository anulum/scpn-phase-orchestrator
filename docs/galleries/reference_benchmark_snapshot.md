...
| --- | --- | ---: | ---: |
| `auto_binding` | `auto_binding_synthetic_quality` | `n/a` | `45.5643` |
| `autopoietic_lineage` | `autopoietic_lineage_sandbox_gate` | `1` | `12358.6` |
| `bayesian_backends` | `bayesian_backend_fail_closed` | `1` | `2293.98` |
| `bayesian_posterior` | `bayesian_posterior_fit_quality` | `1` | `4795.49` |
| `domain_formal_export` | `domain_formal_safety_exports` | `1` | `20221.8` |
| `evolutionary_mutation_grammars` | `evolutionary_mutation_grammar_gate` | `1` | `413.918` |
| `evolutionary_supervisor_search` | `evolutionary_supervisor_search` | `1` | `3268.85` |
| `federated_deployment_preflight` | `federated_deployment_preflight_gate` | `1` | `1180.47` |
| `federated_meta_orchestrator` | `federated_meta_orchestrator` | `1` | `3328.27` |
| `federated_production_boundary` | `federated_production_boundary_gate` | `1` | `1192.09` |
| `formal_export` | `formal_export_artifact_quality` | `1` | `5640.33` |
| `hybrid_cocompiler` | `hybrid_cocompiler_review_gate` | `1` | `7094.31` |
| `hybrid_entanglement_order` | `hybrid_entanglement_order_parameter_gate` | `1` | `1209.26` |
| `hybrid_operator_handoff` | `hybrid_operator_handoff_package_gate` | `1` | `10329.5` |
| `hybrid_target_readiness` | `hybrid_target_readiness_gate` | `1` | `15115.7` |
| `information_geometry_control` | `information_geometry_control_gate` | `1` | `1.13642` |
| `integrated_information_replay_corpus` | `integrated_information_replay_corpus_gate` | `1` | `139.411` |
| `intergenerational_inheritance` | `intergenerational_policy_inheritance_gate` | `1` | `5037.09` |
| `kuramoto` | `kuramoto_reference_strogatz_2000` | `n/a` | `8674.7` |
| `meta_transfer` | `meta_transfer_package_manifest_quality` | `1` | `5119.76` |
| `meta_transfer_corpus` | `meta_transfer_audit_corpus_quality` | `1` | `531.882` |
| `morphogenetic_domain_demos` | `morphogenetic_domain_demo_gate` | `1` | `29.0771` |
| `multiverse_counterfactual` | `multiverse_counterfactual_gate` | `1` | `584.541` |
| `neuromorphic_target_readiness` | `neuromorphic_target_readiness_gate` | `1` | `7957.89` |
| `petri_reachability` | `petri_net_reachability` | `n/a` | `161401` |
| `plugin_ecosystem` | `plugin_ecosystem_catalog_quality` | `1` | `5480.69` |
| `quantum_target_readiness` | `quantum_target_readiness_gate` | `1` | `11840.8` |
| `replay_policy` | `replay_policy_candidate_quality` | `1` | `335.941` |
| `self_model_digital_twin` | `self_model_digital_twin` | `1` | `564.707` |
| `semantic_retrieval` | `semantic_retrieval_ranking_quality` | `1` | `97.3468` |
| `sheaf_obstruction_domains` | `sheaf_obstruction_domain_gate` | `1` | `27.172` |
| `stl_closed_loop` | `stl_closed_loop_plan_quality` | `1` | `6095.5` |
| `stuart_landau` | `stuart_landau_reference_pikovsky_2001` | `n/a` | `6881.55` |
| `temporal_causal_hypergraph` | `temporal_causal_hypergraph_experiment_gate` | `1` | `3486.48` |
| `topos_semantic_binding` | `topos_semantic_binding_gate` | `1` | `41.4557` |
| `value_alignment_replay_calibration` | `value_alignment_replay_calibration_gate` | `1` | `13909.2` |
...
```json
{
  ...
  "steps_per_second": 45.56432435926302,
  "suite": "auto_binding_synthetic_quality",
  "validation_error_count": 0,
  "wall_time_s": 0.08778798009734601
}
```
...
```json
{
  ...
  "steps_per_second": 12358.618759173718,
  "suite": "autopoietic_lineage_sandbox_gate",
  "wall_time_s": 0.00040457595605403185
}
```
...
```json
{
  ...
  "sample_count": 96,
  "steps_per_second": 4795.486732653185,
  "suite": "bayesian_posterior_fit_quality",
  "wall_time_s": 0.020018822979182005,
...
```json
{
  ...
  "failed_domain_count": 0,
  "steps_per_second": 20221.814229925163,
  "suite": "domain_formal_safety_exports",
  "wall_time_s": 0.0004450639244168997
}
```
...
```json
{
  ...
  "steps_per_second": 413.91779510720386,
  "suite": "evolutionary_mutation_grammar_gate",
  "wall_time_s": 0.04831877304241061
}
```
...
```json
{
  ...
  "steps_per_second": 3268.8528921277943,
  "stl_filter_rejected_count": 4,
  "suite": "evolutionary_supervisor_search",
  "wall_time_s": 0.00642427196726203
}
```
...
```json
{
  ...
  "steps_per_second": 3328.2744265172887,
  "suite": "federated_meta_orchestrator",
  "total_sample_count": 300,
  "wall_time_s": 0.0009013679809868336
}
```
...
```json
{
  ...
  "steps_per_second": 5640.329775980679,
  "stl_prism_bytes": 808,
  "suite": "formal_export_artifact_quality",
  "wall_time_s": 0.0008864729898050427
}
```
...
```json
{
  ...
  "scenario_count": 8,
  "steps_per_second": 1209.2572787301885,
  "suite": "hybrid_entanglement_order_parameter_gate",
  "wall_time_s": 0.006615631049498916
}
```
...
```json
{
  ...
  "steps_per_second": 10329.462571646913,
  "suite": "hybrid_operator_handoff_package_gate",
  "wall_time_s": 0.00019362091552466154
}
```
...
```json
{
  ...
  "record_count": 2,
  "steps_per_second": 15115.672893643978,
  "suite": "hybrid_target_readiness_gate",
  "wall_time_s": 0.00013231299817562103
}
```
...
```json
{
  ...
  "scenario_count": 4,
  "steps_per_second": 1.1364151660037662,
  "suite": "information_geometry_control_gate",
  "wall_time_s": 3.5198403890244663
}
```
...
```json
{
  ...
  "steps_per_second": 139.41079349032546,
  "suite": "integrated_information_replay_corpus_gate",
  "wall_time_s": 0.08607654902152717
}
```
...
```json
{
  ...
  "steps_per_second": 5037.08625035037,
  "suite": "intergenerational_policy_inheritance_gate",
  "wall_time_s": 0.0003970549441874027
}
```
...
```json
{
  ...
  "n_oscillators": 64,
  "n_steps": 1000,
  "steps_per_second": 8674.69922463009,
  "suite": "kuramoto_reference_strogatz_2000",
  "wall_time_s": 0.11527777207084
}
```
...
```json
{
  ...
  "package_sha256": "533acf3b37aa233b7a53da1903c99865a7e34055d3d5bcacef3501c3b9fd273f",
  "record_count": 4,
  "steps_per_second": 5119.764567711116,
  "suite": "meta_transfer_package_manifest_quality",
  "wall_time_s": 0.0007812859257683158
}
```
...
```json
{
  ...
  "record_count": 6,
  "steps_per_second": 531.8822169337459,
  ...
  "wall_time_s": 0.011280692997388542
}
```
...
```json
{
  ...
  "steps_per_second": 584.5411666166134,
  "suite": "multiverse_counterfactual_gate",
  "wall_time_s": 0.006842973991297185
}
```
...
```json
{
  ...
  "steps_per_second": 161400.58504117842,
  "suite": "petri_net_reachability",
  "wall_time_s": 0.030978822032921016
}
```
...
```json
{
  ...
  "steps_per_second": 5480.693387643016,
  "suite": "plugin_ecosystem_catalog_quality",
  "wall_time_s": 0.0005473759956657887
}
```
...
```json
{
  ...
  "steps_per_second": 335.94083224740893,
  "suite": "replay_policy_candidate_quality",
  "unsafe_acceptance_count": 0,
  "wall_time_s": 0.02679043193347752
}
```
...
```json
{
  ...
  "steps_per_second": 564.7068663881547,
  "suite": "self_model_digital_twin",
  "wall_time_s": 0.007083320990204811
}
```
...
```json
{
  ...
  "steps_per_second": 27.171982451677128,
  "suite": "sheaf_obstruction_domain_gate",
  "summary_count": 6,
  "top_residual_edge_count": 18,
  "wall_time_s": 0.22081568802241236
}
```
...
```json
{
  ...
  "steps_per_second": 6095.503999598834,
  "suite": "stl_closed_loop_plan_quality",
  "wall_time_s": 0.0004921660292893648
}
```
...
```json
{
  ...
  "n_oscillators": 64,
  "n_steps": 1000,
  "steps_per_second": 6881.552498653018,
  "suite": "stuart_landau_reference_pikovsky_2001",
  "wall_time_s": 0.14531604608055204
}
```
...
```json
{
  ...
  "research_only": 1,
  "steps_per_second": 3486.4832164534037,
  "suite": "temporal_causal_hypergraph_experiment_gate",
  "wall_time_s": 0.0005736439488828182
}
```
...
```json
{
  ...
  "steps_per_second": 41.45573385369357,
  ...
  "wall_time_s": 0.14473269297741354
}
```
