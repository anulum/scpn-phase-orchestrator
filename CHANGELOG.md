...
- A reactor-family-neutral, byte-canonical and digest-sealed device diagnostic-
  ...
  focus, MagLIF, mechanical-or-liquid-liner MIF, plasma-jet MIF, laser-ICF,
  ion/electron-beam ICF, and projectile-impact ICF fixtures exercise distinct
  event-cycle, complex-mode, bounded-feature, and numerical-phase declarations.
