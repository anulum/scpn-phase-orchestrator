...
# SCPN Phase Orchestrator — Power-grid morphogenetic field demo
...
def grid_stress_demo_phases() -> FloatArray:
    """Return deterministic layer phases for a grid-stress replay."""
    return np.array(
        [
            0.00,
            0.02,
...
def run_demo() -> dict[str, object]:
    """Run one morphogenetic topology-field step for the power-grid domainpack."""
    ...
    return {
        ...
        "scenario": "generation_area_stable_load_renewable_stress",
        "policy": {
