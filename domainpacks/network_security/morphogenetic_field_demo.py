...
# SCPN Phase Orchestrator — Network-security morphogenetic field demo
...
def network_security_morphogenetic_phases() -> FloatArray:
    """Return traffic/attack/defence phases for a lateral-movement replay."""
    return np.array([0.00, 2.80, 0.05], dtype=np.float64)


def run_demo() -> dict[str, object]:
    """Run one morphogenetic topology-field step for network security."""
    ...
    return {
        ...
        "scenario": "lateral_movement_defence_field_replay",
        "policy": {
